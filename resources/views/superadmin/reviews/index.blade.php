    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
        <div class="flex items-center justify-between">
            ...
            <div class="w-12 h-12 bg-indigo-100 rounded-xl flex items-center justify-center">
                <svg class="w-6 h-6 text-indigo-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path></svg>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-slate-100 flex flex-wrap gap-4 items-center justify-between">
            ...
            <div class="flex gap-2">
                <select name="rating_filter" onchange="if(this.value) window.location.href='{{ route('superadmin.reviews.index') }}?rating='+this.value" class="px-4 py-2 rounded-xl border border-slate-200 text-sm font-medium">
                ...
                <select onchange="if(this.value) window.location.href='{{ route('superadmin.reviews.index') }}?status='+this.value" class="px-4 py-2 rounded-xl border border-slate-200 text-sm font-medium">
