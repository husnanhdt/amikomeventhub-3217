    ...
    <form action="#" method="POST">
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="app_name" value="AmikomEventHub" 
                ...
                <div>
                    ...
                    <input type="url" name="app_url" value="http://127.0.0.1:8000" 
                           class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition">
                </div>
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8 mb-8">
            ...
            <div class="flex items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-200">
                <div>
                    <p class="font-bold text-slate-900">Mode Maintenance</p>
        ...
        <div class="flex justify-end gap-4">
            <button type="button" class="px-6 py-3 bg-white text-slate-700 border border-slate-200 rounded-xl font-bold hover:bg-slate-50 transition">
                Batal
            </button>
