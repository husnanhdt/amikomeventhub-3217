...
@section('page_subtitle', 'Buat akun organizer baru beserta organisasinya')
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="organization_name" value="{{ old('organization_name') }}" required
                               class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-indigo-500 outline-none"
                               placeholder="Contoh: HIMASI, CRSL Land Festival">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="organization_description" rows="4"
                                  class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-indigo-500 outline-none"
                                  placeholder="Deskripsi singkat tentang organisasi...">{{ old('organization_description') }}</textarea>
